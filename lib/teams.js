/**
 * teams.js — discover and read team packages from the ccpm source repo.
 *
 * Teams live at <ccpm-repo-root>/teams/<team-name>/ and are resolved relative
 * to this file's location (import.meta.url), so the path works regardless of
 * where the user runs ccpm from (process.cwd is the user's project, not ours).
 */
...
// Resolve the ccpm source root from this file's location.
