...
export const TEAM_LESSONS_HASH_LEDGER = Object.freeze([
  ...
  // prettier version. AUTHORING.md changed too (its formatter caveats now
  // describe the bare-`*`/`*em*` risk this fix leaves in place); only
  // lessons-index.mjs carries its v8 digest forward.
  Object.freeze({
    version: 9,
    files: Object.freeze({
