...
3. **Regressions**
   Run the full test suite. Any previously-passing test that now fails is a regression — flag it immediately as the top finding.
...
- **Missing tests:** describe each as "test name / scenario / expected behavior" for the builder to implement.
